        ...
        function editProduct(button) {
            ...
            document.getElementById('productPrice').value = row.querySelector('.price').textContent.replace(' VND', '');
        ...
        function resetForm() {
            ...
            document.getElementById('submitProductBtn').textContent = 'Thêm sản phẩm';
